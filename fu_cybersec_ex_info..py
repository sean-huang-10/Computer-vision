...
import pandas as pd
from selenium_cybersec_scraper_api  import (get_exd_detail,create_webdriver)
import time

def get_cyberssec_exd_info(is_export_to_csv=True):  #先找input
    ...
    web_driver = create_webdriver()  #在迴圈外創建瀏覽器
...
if __name__ == '__main__':
 data = get_cyberssec_exd_info(is_export_to_csv=True)
 print(data[:5])
